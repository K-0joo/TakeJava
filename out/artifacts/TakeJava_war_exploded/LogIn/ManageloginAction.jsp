...
<jsp:setProperty name="ManageUser" property="admin_id" />

<!-- loginAction.jsp 안에 넘어온 데이터들이 그대로 담기게 됨. -->
<jsp:setProperty name="ManageUser" property="admin_pwd" />
...
//    }
    ...
    int result = manageUserDAO.login(ManageUser.getAdmin_id(), ManageUser.getAdmin_pwd());

    // login 함수에서 return 값이 1이라면
    if(result == 1) {
        session.setAttribute("admin_id", ManageUser.getAdmin_id());
