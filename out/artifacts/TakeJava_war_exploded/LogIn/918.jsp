...
<head>
    ...
    <%
        ...
        boolean seminar = Dao.isSeminar(918);
        List<Seat> seatList =new ArrayList<>();
        if (!seminar) {
            seatList = Dao.seatStatus(918);
        }
        int count = 1;
    %>
    <style>
    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="916.jsp" class="nav-link px-2 link-secondary">916</a></li>
                <li><a href="918.jsp" class="nav-link px-2 link-blue">918</a></li>
                <li><a href="911.jsp" class="nav-link px-2 link-secondary">911</a></li>
            </ul>
